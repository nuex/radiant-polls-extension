...
describe Poll do
  ...
  context 'validations' do
    ...
    it 'should require a title' do
      ...
      @poll.errors.on(:title) == ActiveRecord::Errors.default_error_messages[:blank]
    end
    ...
    it 'should not accept a duplicate title' do
      ...
      poll.should_not be_valid
      poll.errors.on(:title) == ActiveRecord::Errors.default_error_messages[:taken]
    end
    ...
    it 'should not accept a duplicate start date' do
      ...
      poll = Poll.new(:title => 'New Poll',
                      ...
                      :options => [ Option.new(:title => 'True'),
                                    Option.new(:title => 'False') ])
      poll.should_not be_valid
      poll.errors.on(:start_time) == ActiveRecord::Errors.default_error_messages[:taken]
    end
